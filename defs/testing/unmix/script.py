...
#region Main Loop, discontinued

if __name__ == "__main__":

    from .auxiliary.auxiliary import setup_logging, setup_wandb

    # Get the configs
    cfg_run = cfg_from_args()
    cfg_import, cfg_loader, cfg_train, cfg_export, cfg_critic_setup, cfg_critictrain_setup = parse_cfg_dict(cfg_run)
