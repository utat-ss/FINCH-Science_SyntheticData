...
class LossKLSAM(nn.Module):
    ...
    def forward(self, x_0_hat:(torch.Tensor), x_0:(torch.Tensor), mu:(torch.Tensor), variation:(torch.Tensor), SAM_coefficient=1, KL_coefficient=1, MSE_coefficient=5, msesam_ratio = 0.05):
        """
